...
然后填写 [GOAL.md](GOAL.md) 和 [PLAN.md](PLAN.md)，并按[配方](docs/03-recipe-zh-CN.md)推进。
...
1. **理解 [产品]。** [一句话]。参见[概览](docs/01-getting-started-zh-CN.md)。
2. **说明各自分工。** [一句话]。
3. **[Case 01 的目标]。** [一句话]。
4. **[Case 02 的目标]。** [一句话]。
...
| 文档 | 内容 |
| --- | --- |
| [开始使用](docs/01-getting-started-zh-CN.md) | 配置、环境变量、运行、故障排查 |
| [提供方](docs/02-providers-zh-CN.md) | ChatGPT 订阅与 NVIDIA NIM |
| [配方](docs/03-recipe-zh-CN.md) | 从想法到 `v0.1.0` |
